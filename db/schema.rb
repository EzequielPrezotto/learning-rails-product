...
ActiveRecord::Schema.define(version: 2021_03_08_155509) do
  ...
  create_table "product_colors", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "products_id", null: false
    t.index ["products_id"], name: "index_product_colors_on_products_id"
  end
  ...
  add_foreign_key "product_colors", "products", column: "products_id"
end
